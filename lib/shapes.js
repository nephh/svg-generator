// The Shape class will handle actually creating the svg file.
class Shape {
...
// We inherit Shape in order to change this.tag depending on the class, which will determine what createSVG outputs.
